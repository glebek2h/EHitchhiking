...
//
//    @Override
//    public BlacklistPass getBlacklist(int id) {
//        return getCurrentSession().get(BlacklistPass.class, id);
//    }
//
//    @Override
//    public BlacklistPass getBlackList(int passId, int driverId) {
//        return (BlacklistPass) getCurrentSession().createQuery("from BlacklistPass where passenger.id = '" + passId + "' and driverId" + driverId + "'").uniqueResult();
//    }
//}
